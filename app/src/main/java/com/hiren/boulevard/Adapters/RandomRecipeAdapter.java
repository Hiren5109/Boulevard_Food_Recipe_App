...
import com.hiren.boulevard.Models.Recipe;
...
public class RandomRecipeAdapter extends RecyclerView.Adapter<RandomRecipeViewHolder> {
    ...
    public RandomRecipeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new RandomRecipeViewHolder(LayoutInflater.from(context).inflate(R.layout.activity_list_random_recipe,parent,false));
    }
...
class RandomRecipeViewHolder extends RecyclerView.ViewHolder{
    ...
    public RandomRecipeViewHolder(@NonNull View itemView) {
        ...
        textView_like=itemView.findViewById(R.id.textView_likes);
